  ...
  return (
    <div className='overflow-x-hidden'>
      ...
      <div className="h-[400px] lg:h-[450px]  flex justify-center items-center relative">
        <img src={contactImage} alt="Your Image" className="h-full w-full object-cover"/>
        <div className="absolute inset-0 bg-black opacity-25"></div>
        <div className='absolute top-1/2  transform  -translate-y-1/2 px-5'>
        <p className='text-[45px] lg:text-[100px] text-center nothing-font text-white animate__animated animate__fadeInLeft'>Contact Us</p>
